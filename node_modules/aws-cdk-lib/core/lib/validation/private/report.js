"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PolicyValidationReportFormatter=void 0;const os=require("os"),path=require("path"),table_1=require("table"),trace_1=require("./trace"),report=require("../report");class PolicyValidationReportFormatter{constructor(tree){this.tree=tree,this.reportTrace=new trace_1.ReportTrace(tree)}formatPrettyPrinted(reps){const json=this.formatJson(reps),output=[json.title];return output.push("-".repeat(json.title.length)),json.pluginReports.forEach(plugin=>{output.push(""),output.push(table_1.table([[`Plugin: ${plugin.summary.pluginName}`],[`Version: ${plugin.version??"N/A"}`],[`Status: ${plugin.summary.status}`]],{header:{content:"Plugin Report"},singleLine:!0,columns:[{paddingLeft:3,paddingRight:3}]})),plugin.summary.metadata&&(output.push(""),output.push(`Metadata: 
